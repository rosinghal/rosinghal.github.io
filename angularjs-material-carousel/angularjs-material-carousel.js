	...
	app.directive('materialCarousel', ['$compile', function($compile) {
	    return {
	        ...
	        link: function(scope, element, attrs) {
  				...
  				var html = `<md-tabs md-border-bottom md-dynamic-height md-swipe-content md-center-tabs md-align-tabs="bottom" md-selected="selectedTabSlider" class="amc-slider-wrapper" ng-class="{ 'amc-hide-tabs-header amc-product-slider-wrapper-single-tab' : slides.length === 1}">
  					<md-tab ng-repeat="slide in slides">
  						<md-tab-label>
  							<span class="amc-slider-tab-label">&bull;</span>
						</md-tab-label>
						<md-tab-body>
