...
var PouchDB = __webpack_require__(807);
var DbService = (function () {
    ...
    DbService.prototype.addNote = function (subject, body, _rev, _id, project) {
        if (project === void 0) { project = 'Default'; }
        if (_rev && _id) {
            return this.db.put({ subject: subject, body: body, _rev: _rev, _id: _id, project: project });
        }
        else {
            return this.db.post({ subject: subject, body: body, project: project });
        }
    };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__db_service__ = __webpack_require__(257);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__(253);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_switchMap__ = __webpack_require__(469);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_switchMap___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_switchMap__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_material__ = __webpack_require__(239);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_Subject__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_Subject___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_rxjs_Subject__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_map__ = __webpack_require__(124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_add_operator_debounceTime__ = __webpack_require__(821);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_rxjs_add_operator_distinctUntilChanged__ = __webpack_require__(822);
...
var DetailComponent = (function () {
    function DetailComponent(db, router, route, snackBar) {
        ...
        this.body$ = new __WEBPACK_IMPORTED_MODULE_5_rxjs_Subject__["Subject"]();
        this.form = {
            subject: null,
            body: null,
            _id: null,
        ...
        this.body$.debounceTime(400)
            ...
            .switchMap(function (body) { return _this.db.addNote(_this.form.subject, body, _this.form._rev, _this.form._id); })
            .subscribe(function (note) { return _this.handleResponse(note); });
        this.subject$.debounceTime(400)
            .distinctUntilChanged()
            .switchMap(function (subject) { return _this.db.addNote(subject, _this.form.body, _this.form._rev, _this.form._id); })
            .subscribe(function (note) { return _this.handleResponse(note); });
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_app_module__ = __webpack_require__(641);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_material__ = __webpack_require__(239);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_hammerjs__ = __webpack_require__(803);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_hammerjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_hammerjs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__db_service__ = __webpack_require__(257);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__angular_common__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__safe_html_pipe__ = __webpack_require__(645);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__app_routing_module__ = __webpack_require__(639);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__detail_detail_module__ = __webpack_require__(643);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__list_list_component__ = __webpack_require__(644);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__detail_routing_module__ = __webpack_require__(642);
...
var ListComponent = (function () {
    ...
    ListComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__db_service__["a" /* DbService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__db_service__["a" /* DbService */]) === 'function' && _b) || Object])
    ], ListComponent);
